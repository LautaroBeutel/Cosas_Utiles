...
byte X_2[] = {0x0,0x6,0x6,0x0,0x0,0x60,0x60,0x0};
byte X_3[] = {0x0,0x6,0x6,0x18,0x18,0x60,0x60,0x0};
...
byte Cor_1[] = {0x0,0x66,0xff,0xff,0xff,0x7e,0x3c,0x18};

//****************************************************************************************************************************************//

void Escribir(int pin_data, int pin_clock, int pin_latch, byte DATA){       //Funcion para enviar data al 74hc595
